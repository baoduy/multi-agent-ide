...
import { DatabaseService } from "./core/db/DatabaseService";
import { IPCBridge } from "./core/ipc/IPCBridge";
import { registerHandlers } from "./core/ipc/registerHandlers";

import { BackgroundJobManager } from "./modules/jobs/BackgroundJobManager";
import { DirWatcher } from "./modules/repos/persistence/DirWatcher";
import { RepoRepository } from "./modules/repos/persistence/RepoRepository";
import { RepoScanner } from "./modules/repos/persistence/RepoScanner";
import { ScanQueue } from "./modules/repos/persistence/ScanQueue";

import { SpecRepository } from "./modules/specs/persistence/SpecRepository";
import { SpecSyncService } from "./modules/specs/persistence/SpecSyncService";
import { TerminalApplicationService } from "./modules/terminal/app/TerminalApplicationService";
import { AISessionApplicationService } from "./modules/agent-cli/app/AISessionApplicationService";
import { SessionSyncApplicationService } from "./modules/synced-sessions/app/SessionSyncApplicationService";
import { WorktreeSyncApplicationService } from "./modules/worktrees/app/WorktreeSyncApplicationService";
import { SyncedSessionRepository } from "./modules/synced-sessions/persistence/SyncedSessionRepository";
import { WorktreeRepository } from "./modules/worktrees/persistence/WorktreeRepository";
import { SessionSyncGateway } from "./modules/synced-sessions/infra/SessionSyncGateway";
import { SessionFileWatcher } from "./modules/synced-sessions/infra/SessionFileWatcher";
import { GitGateway } from "./modules/repos/infra/GitGateway";
import { FileSystemGateway } from "./modules/filesystem/infra/FileSystemGateway";
import { SpecGitGateway } from "./modules/specs/infra/SpecGitGateway";
import { SpecReader } from "./modules/specs/persistence/SpecReader";
import { GitBatchGateway } from "./modules/repos/infra/GitBatchGateway";
import { GitRepoWatcher } from "./modules/repos/infra/GitRepoWatcher";
...
import { GitHubReleasesGateway } from "./modules/repos/infra/GitHubReleasesGateway";
import { NpmRegistryGateway } from "./modules/repos/infra/NpmRegistryGateway";
import { CliVersionApplicationService } from "./modules/agent-cli/app/CliVersionApplicationService";
import { SpecifyExtensionApplicationService } from "./modules/specs/app/SpecifyExtensionApplicationService";
import { AiConfigRepository } from "./modules/agent-cli/infra/AiConfigRepository";
import { AiCliGateway } from "./modules/agent-cli/infra/AiCliGateway";
import { AiEditApplicationService } from "./modules/agent-cli/app/AiEditApplicationService";
import { AIRunOnceApplicationService } from "./modules/agent-cli/app/AIRunOnceApplicationService";
import { AiBareRunApplicationService } from "./modules/agent-cli/app/AiBareRunApplicationService";
import { TempFileGateway } from "./modules/filesystem/infra/TempFileGateway";
import { FileWatcherGateway } from "./modules/filesystem/infra/FileWatcherGateway";
import { FileWatchService } from "./modules/filesystem/app/FileWatchService";
import { AiPresetRepository } from "./modules/agent-cli/persistence/AiPresetRepository";
import { AiPresetService } from "./modules/agent-cli/app/AiPresetService";
import { PermissionPromptCoordinator } from "./modules/agent-cli/app/PermissionPromptCoordinator";
import { PermissionPromptMcpServer } from "./modules/agent-cli/infra/PermissionPromptMcpServer";
import { ClaudeAgentsGateway } from "./modules/agent-cli/claude/ClaudeAgentsGateway";
import { AgentService } from "./modules/agent-cli/app/AgentService";
import { PluginDirRepository } from "./modules/config/persistence/PluginDirRepository";
import { PluginDirService } from "./modules/config/app/PluginDirService";
import { SessionObservabilityService } from "./core/observability/SessionObservabilityService";
import { DebugLogService } from "./core/observability/DebugLogService";
import { ChatThreadRepository } from "./modules/chat/persistence/ChatThreadRepository";
import { ChatThreadService } from "./modules/chat/app/ChatThreadService";
