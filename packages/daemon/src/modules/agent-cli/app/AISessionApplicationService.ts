...
import { parseWorkspaceYaml } from "../copilot/sessionParser";
import { extractTitleFromContent } from "../claude/sessionParser";
import type { IPCBridge } from "../../../core/ipc/IPCBridge";
import { buildAllowlist, resolveAndAssert, type PathAllowlistProvider } from "../core/pathGuard";
import { resolveSessionCwd } from "../core/sessionCwdResolver";
import { getAllProviderMeta, getProviderMeta } from "../core/providerRegistry";
import { getSessionFactory } from "../sessions";
import { sessionConfigToSpawn } from "../sessions/BaseAISession";
import type { BaseAISession } from "../sessions";
import { getProviderCapability } from "@magenta/shared/providerCapabilities";
import { getToArgv } from "../core/providerArgv";
import { resolveSessionId } from "../core/sessionIdResolver";
import { buildForkArgv } from "../core/forkArgvBuilder";
import { awaitProviderSessionId } from "../core/awaitProviderSessionId";
