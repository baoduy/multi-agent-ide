...
import { CliVersionProbe, isNewerVersion, normalizeReleaseTag } from "../infra/CliVersionProbe";
import type { GitHubReleasesGateway } from "../../repos/infra/GitHubReleasesGateway";
import type { NpmRegistryGateway } from "../../repos/infra/NpmRegistryGateway";
import type { SpecifyExtensionApplicationService } from "../../specs/app/SpecifyExtensionApplicationService";
